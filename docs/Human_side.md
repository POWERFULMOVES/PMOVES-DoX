...
Welcome to the PMOVES CHIT (Compressed Hierarchical Information Transfer) attribution system. This guide explains how your contributions to the ToKenism cooperative are tracked, weighted, and verified.
